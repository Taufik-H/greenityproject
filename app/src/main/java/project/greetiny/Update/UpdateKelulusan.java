...
public class UpdateKelulusan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_kelulusan);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UpdateKelulusan.this, FragmentList.class);
    ...
    private void updateCard() {
        ...
        cardRef.updateChildren(updates)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(UpdateKelulusan.this, "Card updated successfully", Toast.LENGTH_SHORT).show();

                    // Return to FragmentList
                    Intent intent = new Intent(UpdateKelulusan.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(UpdateKelulusan.this, "Failed to update card", Toast.LENGTH_SHORT).show();
