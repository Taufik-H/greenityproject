...
public class UpdateTahunBaru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_tahun_baru);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UpdateTahunBaru.this, FragmentList.class);
    ...
    private void updateCard() {
        ...
        cardRef.updateChildren(updates)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(UpdateTahunBaru.this, "Card updated successfully", Toast.LENGTH_SHORT).show();

                    // Return to FragmentList
                    Intent intent = new Intent(UpdateTahunBaru.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(UpdateTahunBaru.this, "Failed to update card", Toast.LENGTH_SHORT).show();
