...
public class UpdateNikahan extends AppCompatActivity {
    private EditText updateKirimke, updateUcapan, updateKirimkeA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_nikahan);
        ...
        updateKirimkeA = findViewById(R.id.update_subjectA);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UpdateNikahan.this, FragmentList.class);
        ...
        subjectA = intent.getStringExtra("subjectA");
        ...
        updateKirimkeA.setText(subjectA);
    ...
    private void updateCard() {
        ...
        String updatedSubjectA = updateKirimkeA.getText().toString().trim();
        ...
        updates.put("subjectA", updatedSubjectA);
        ...
        cardRef.updateChildren(updates)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(UpdateNikahan.this, "Card updated successfully", Toast.LENGTH_SHORT).show();

                    // Return to FragmentList
                    Intent intent = new Intent(UpdateNikahan.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(UpdateNikahan.this, "Failed to update card", Toast.LENGTH_SHORT).show();
