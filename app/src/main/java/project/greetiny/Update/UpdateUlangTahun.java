...
import project.greetiny.adapter.dataupdate;
import project.greetiny.adapter.model;
import project.greetiny.fragment.FragmentList;
import project.greetiny.ucapan.data_ulangTahun;



public class UpdateUlangTahun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_ulang_tahun);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UpdateUlangTahun.this, FragmentList.class);
    ...
    private void updateCard() {
        ...
        cardRef.updateChildren(updates)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(UpdateUlangTahun.this, "Card updated successfully", Toast.LENGTH_SHORT).show();

                    // Return to FragmentList
                    Intent intent = new Intent(UpdateUlangTahun.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(UpdateUlangTahun.this, "Failed to update card", Toast.LENGTH_SHORT).show();
