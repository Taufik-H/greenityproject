...
public class TahunBaru extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tahun_baru);
    ...
    private void checkUser() {
        ...
        if(TextUtils.isEmpty(getSubject)|| TextUtils.isEmpty(getObject)|| TextUtils.isEmpty(getTanggal)|| TextUtils.isEmpty(getUcapan)||uri == null){
            ...
            Toast.makeText(TahunBaru.this, "Masih ada yang kosong!!", Toast.LENGTH_SHORT).show();
        }else{
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            tahunbaru.setSubject(getSubject);
                            tahunbaru.setObject(getObject);
                            tahunbaru.setTanggal(getTanggal);
                            ...
                            databaseReference.push().setValue(tahunbaru).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        getGambar = "";
                                        Toast.makeText(TahunBaru.this, "Data Berhasil Tersimpan", Toast.LENGTH_SHORT).show();
                                        //progressBar.setVisibility(View.GONE);
                                        Intent intent = new Intent(TahunBaru.this, MainActivity.class);
                                        startActivity(intent);
                                        finish();
                                    } else {
                                        Toast.makeText(TahunBaru.this, "Data Gagal Tersimpan", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        }
